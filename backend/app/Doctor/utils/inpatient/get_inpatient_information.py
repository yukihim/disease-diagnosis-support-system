...
def get_inpatient_general_information(inpatient_session_id: int):
    """
    Get general information of a patient by id
    """
    from ....database.models import Patients, Inpatient_session
    ...
    stmt = select(
        ...
        Inpatient_session.id == inpatient_session_id
    )
