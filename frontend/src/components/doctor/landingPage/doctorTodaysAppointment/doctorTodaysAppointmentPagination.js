...
function DoctorTodaysAppointmentPagination({ currentPage, totalPages, onPageChange, rowsPerPageOptions, currentRowsPerPage, onRowsPerPageChange }) {
    ...
    return (
        <ComponentPagination>
            ...
            <div style={{
                ...
                <label
                    htmlFor="rowsPerPageSelectTodaysAppt" // Use a unique ID
                    style={{
                ...
                <select
                    id="rowsPerPageSelectTodaysAppt" // Use a unique ID
