...
function DoctorPatientSentForParaclinicalTestPagination({ currentPage, totalPages, onPageChange, rowsPerPageOptions, currentRowsPerPage, onRowsPerPageChange }) {
    ...
    return (
        <ComponentPagination>
            ...
            <div style={{
                ...
                <label
                    htmlFor="rowsPerPageSelectParaTest" // Use a unique ID
                    style={{
                ...
                <select
                    id="rowsPerPageSelectParaTest" // Use a unique ID
...
export default DoctorPatientSentForParaclinicalTestPagination;