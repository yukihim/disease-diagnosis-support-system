...
function AdminUserAccountLogPagination({ currentPage, totalPages, onPageChange, rowsPerPageOptions, currentRowsPerPage, onRowsPerPageChange }) {
    ...
    return (
        <ComponentPagination>
            ...
            <div style={{
                ...
                <label
                    htmlFor="rowsPerPageSelectLog" // Use a unique ID if needed
                    style={{
                ...
                <select
                    id="rowsPerPageSelectLog" // Use a unique ID if needed
...
export default AdminUserAccountLogPagination;