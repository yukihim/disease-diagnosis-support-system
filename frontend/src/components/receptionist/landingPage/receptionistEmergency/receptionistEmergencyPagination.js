...
function ReceptionistEmergencyPagination({ currentPage, totalPages, onPageChange, rowsPerPageOptions, currentRowsPerPage, onRowsPerPageChange }) {
    ...
    return (
        <ComponentPagination>
            ...
            <div style={{
                ...
                <label
                    htmlFor="rowsPerPageSelectEmergency" // Use a unique ID
                    style={{
                ...
                <select
                    id="rowsPerPageSelectEmergency" // Use a unique ID
...
export default ReceptionistEmergencyPagination;