...
// function ReceptionistAppointmentPagination({ currentPage, totalPages, onPageChange }) {
//     return (
//         <ComponentPagination>
//             <PrevButton 
...
function ReceptionistAppointmentPagination({ currentPage, totalPages, onPageChange, rowsPerPageOptions, currentRowsPerPage, onRowsPerPageChange }) {
    ...
    return (
        <ComponentPagination>
            ...
            <div style={{
                ...
                <label
                    htmlFor="rowsPerPageSelectAppt" // Use a unique ID
                    style={{
                ...
                <select
                    id="rowsPerPageSelectAppt" // Use a unique ID
